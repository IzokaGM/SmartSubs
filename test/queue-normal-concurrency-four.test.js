...
test('normal Queue uses 160/20000/4, retry remains 180/24000/2', async () => {
  ...
  assert.deepEqual(queueTranslationOptions(env, 1), { maxItems: 160, maxChars: 20000, concurrency: 4 })
...
test('normal five-chunk episode runs up to four Gemini requests at once, with no extra calls', async () => {
