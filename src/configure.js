...
function renderConfigurePage(options = {}) {
  ...
  const result = options.manifestUrl
    ? `<div class="result"><p>SmartSubs is configured.</p><p><a href="${escapeHtml(options.installUrl || '')}">Install in Stremio</a></p><p><a href="${escapeHtml(options.diagnoseUrl || '')}">Open Diagnose</a></p><code>${escapeHtml(options.manifestUrl)}</code></div>`
    : ''
